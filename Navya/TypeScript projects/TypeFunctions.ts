...
() => "a value" ;
var op=(a:number)=>(x:number,y:number)=>{console.log(x+y); return 1;};
console.log(op(2)(3,4));

//BODMAS
var ad=(a:number,b:number)=>a+b;
var mul=(a:number,b:number)=>a*b;
var div=(a:number,b:number)=>a/b;
var sub=(a:number,b:number)=>a-b;
var mystring:string = "3+5*8-5";
...
var priority=function(ch:string):Number{
    if(ch=='+'||ch=='-')
    return 1;
    else
    return 2;
